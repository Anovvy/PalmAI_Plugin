# -*- coding: utf-8 -*-
"""U-Net_Pretrained_Detection_Hybrid-PostProcessing.ipynb
"""
...
# !pip install rasterio geopandas scikit-image tqdm skan torch torchvision pandas networkx scipy segmentation-models-pytorch
...
MODEL_PATH = '/content/drive/MyDrive/Road Detection_Data_/Model/unet_resnet50_roaddetection_1.pth.tar'
...
OUTPUT_SHAPEFILE_PATH = '/content/drive/MyDrive/Road Detection_Data_/Hasil Prediksi/U-Net ResNet50/PreUNet_Detection_2.1.shp'
# Path for saving raster results
OUTPUT_RASTER_PATH = '/content/drive/MyDrive/Road Detection_Data_/Hasil Prediksi/U-Net ResNet50/PreUNet_Detection_2.1.tif'
# Path for storing the probability map (for tuning)
OUTPUT_PROB_MAP_PATH = '/content/drive/MyDrive/Road Detection_Data_/Hasil Prediksi/U-Net ResNet50/prob_map_2.0.npy'
...
MIN_OBJECT_SIZE_PIXELS = 611
CLOSING_ITERATIONS = 50
PROBABILITY_THRESHOLD = 0.4931

# --- PARAMETER PATHFINDING ---\
PATHFINDING_MAX_GAP_PIXELS = 500
PATHFINDING_COST_FACTOR = 15.0
PATHFINDING_MAX_AVG_COST = 0.7527
PATHFINDING_BBOX_PADDING = 25

# --- PARAMETER FINAL FILTER ---\
MIN_ROAD_LENGTH_METERS = 18.0

# =============================================================================
# STEP 3: DEFINITION OF THE MODEL ARCHITECTURE (SMP)
# =============================================================================
print("Defining the architecture (via SMP; to be loaded in the helper function)...")
...
def load_model(model_path):
    """Loading the pre-trained U-Net (SMP) model and its weights."""
    ...
    try:
        ...
        model.eval() # <<-- PENTING
        print("Model U-Net Pretrained (SMP) loaded successfully.")
    except Exception as e:
...
def main_pipeline():
    ...
    try:
        print("--- Loading a Pre-trained U-Net Model (SMP) ---")
