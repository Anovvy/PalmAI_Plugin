# -*- coding: utf-8 -*-
"""U-Net_Pretrained_Training.ipynb
"""
...
# =====================================================================================
# 0. INSTALLATION OF ADDITIONAL LIBRARIES (COLAB)
# =====================================================================================
try:
    import segmentation_models_pytorch as smp
except ImportError:
    print("Library segmentation-models-pytorch belum terinstall. Installing...")
    import subprocess
    import sys
...
def main():
    ...
    MODEL_FILENAME = "unet_resnet50_roaddetection_1.pth.tar"
    MODEL_SAVE_PATH = os.path.join(MODEL_OUTPUT_DIR, MODEL_FILENAME)
    SAVED_IMAGES_DIR = "/content/drive/MyDrive/Road Detection_Data_/Hasil Prediksi/U-Net ResNet50 Test"
    ...
    # --- Initialisation Model U-Net Pretrained segmentation-models-pytorch(SMP)  ---
    print("=> Loading the U-Net model with a ResNet50 backbone (pre-trained)...")

    # other encoder_name: "efficientnet-b0", "vgg16", etc.
    model = smp.Unet(
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        # Save a sample of the prediction results
