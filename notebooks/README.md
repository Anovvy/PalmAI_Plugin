...
- [`slicing_to_png_randomize.py`](notebooks\slicing_to_png_randomize.py) - Standard tile generation.
- [`spesific_slicing_to_png.py` ](notebooks\spesific_slicing_to_png.py)- Targeted slicing for class balancing.
- [`trainingyolov8.py`](notebooks\trainingyolov8.py) - Model training with HSV augmentation.

### **Road Segmentation Pipeline (Roads)**
### Training Scripts:
- [`u_net_scratch_training.py`](notebooks\u_net_scratch_training.py)
- [`u_net_pretrained_training.py`](notebooks\u_net_pretrained_training.py)
- [`deeplabv3+_training.py`](notebooks\deeplabv3+_training.py)
- [`segformer_training.py`](notebooks\segformer_training.py)
### Inference & Hybrid Post-Processing Scripts:
- [`u_net_scratch_detection_hybrid_postprosessing.py`](notebooks\u_net_scratch_detection_hybrid_postprosessing.py)
- [`u_net_pretrained_detection_hybrid_postprocessing.py`](notebooks\u_net_pretrained_detection_hybrid_postprocessing.py)
- [`deeplabv3+_detection_hybrid_postprosessing.py`](notebooks\deeplabv3+_detection_hybrid_postprosessing.py)
- [`segformer_detection_hybrid_postprosessing.py`](notebooks\segformer_detection_hybrid_postprosessing.py)
### Inference & Hybrid Post-Processing Scripts:
- [`post_processing_parameter_tuning_(gridsearch).py` ](notebooks\post_processing_parameter_tuning_(gridsearch).py) - The automated script used to generate the parameter table above.